public class Date {
	...
	private void setDay(int day) {
		if (day < 1 || day > 31) {
			throw new IllegalArgumentException("day must greater or equal to 1 and less or equal to 31.");
		}
		...
		if (this.month == 2 && ((isLeapYear() && day > 29) || (!isLeapYear() && day > 28))){
			throw new IllegalArgumentException("day must less than 29 for month " + monthNames[month-1] + " on a leap year and less than 28 for month.");
		}
